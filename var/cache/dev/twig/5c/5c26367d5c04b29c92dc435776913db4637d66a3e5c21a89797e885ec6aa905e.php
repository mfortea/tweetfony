...
/* verTweet.html.twig */
class __TwigTemplate_a72ad7c18a2dc1f109e05be61aab0a5fe2b1eae9749e0ed68efaea84a759035e extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_titulo($context, array $blocks = [])
    {
        ...
        echo ": ";
        echo twig_escape_filter($this->env, twig_truncate_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["tweet"]) || array_key_exists("tweet", $context) ? $context["tweet"] : (function () { throw new RuntimeError('Variable "tweet" does not exist.', 2, $this->source); })()), "text", [], "any", false, false, false, 2)), "html", null, true);
...
{% block titulo %}{{tweet.user.name}}: {{tweet.text|truncate}}{{ parent() }}{% endblock %}
{% block principal %}
