...
return [
    ...
    [ // $staticRoutes
        ...
        '/' => [[['_route' => 'index', '_controller' => 'App\\Controller\\TweetController::index'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
    ...
    [ // $dynamicRoutes
        ...
        184 => [
            [['_route' => 'verTweet', '_controller' => 'App\\Controller\\TweetController::verTweet'], ['id'], null, null, false, true, null],
